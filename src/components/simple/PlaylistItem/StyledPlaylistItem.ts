...
const StyledPlaylistItem: any = styled.div`
  font-family: "Hind", sans-serif;
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
  background: none;
  border: ${(props: any) => (props.active ? "2px dotted #696969" : "none")};
  font-size: 1.6em;
  ...
  .main-player-video-nr {
    flex-grow: 1; /* default 0 */
    max-width: 30px;
    padding-right: 20px;
    border-right: 2px solid #565656;
  }
  .main-player-video-name,
  .main-player-video-name a {
